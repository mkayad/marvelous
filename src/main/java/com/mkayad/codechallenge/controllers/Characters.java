...
@Api(value = "Marvel comic characters ",
        description = "The service allows retrieving some details of the Marvel comic characters")
@RestController
public class Characters {
    ...
    private final String languages[]= {"af","am","ar","az","be","bg","bn","bs","ca","ceb","co","cs","cy","da","de","el",
            ...
            "so","sq","sr","st","su","sv","sw","ta","te","tg","th","tl","tr","uk","ur","uz","vi","xh","yi","yo","zh"
            ,"zh-TW","zu"};
    ...
    public @ResponseBody DeferredResult<DataResponse> getCharacterPowers(@PathVariable("characterId") int characterId,
    ...
    private Observable<MarvelResponseWrapper> fetchCharacterDetail(int characterId){
        ...
        return ServiceGenerator
                ...
                .getCharacterDetail(characterId,ts, Application.marvelPublicKey,Application.getHash(ts));
    }

    private Cache getCache(){
        return cacheConfiguration
                .ehCacheCacheManager()
                .getCacheManager().getCache("charactersCache");
    }
}
